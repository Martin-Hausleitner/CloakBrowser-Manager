      ...
      <div className="w-80">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            ...
            className="btn-primary min-h-9 w-full disabled:opacity-50"
          >
        ...
        {accessControlEnabled && (
          <button
            ...
            className="mt-2 flex min-h-9 w-full items-center justify-center text-[11px] text-gray-500 underline hover:text-gray-300"
          >
