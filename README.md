...
- **Mobile task workspace** — browser-first live-VNC split with collapsed chat, one compact tool sheet, typed Quick actions, fullscreen shortcuts, editable viewport, visual zoom and an injected Codex Computer Use host bridge
